...
Usage:
    python bot/main.py                  # Download + post one video
    python bot/main.py --download-only  # Just download and queue videos
    python bot/main.py --post-only      # Post next video from queue
    python bot/main.py --status         # Show queue and posting stats
"""
...
def load_config(config_path="bot/config.yaml"):
